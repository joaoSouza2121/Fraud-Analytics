...
getwd()
setwd("C:/Users/Gateway/Downloads/FraudAnalytics")
...
# Estratégia 2 - Para as variáveis remanescentes, atribuir o valor "Desconhecido" se for variáveis categórica
# Estratégia 3 - Para as variáveis remanescentes, atribuir a media se for variáveis quantitativa
...
# Vamos colocar o valor "Desconhecido" onde estiver NA se for variavel qualitativa
# Para variaveis quantitativas substituímos NA pela meda
...
# Pré-Processamento das Variaveis Categóricas

# Convertemos as variaveis categoricas para o tipo fator
str(dados_full)
...
# Em variaveis do tipo texto vamos aplicar limpeza ao texto para poder separar as categorias
...
# Ajusta a variavel alvo removendo o nivel onde a categoria for "Desconhecido" 
